...
export function QuickOrderBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-3 z-40 px-3 md:hidden">
      <div className="mx-auto flex max-w-xl items-center justify-between gap-3 rounded-[28px] border border-[var(--color-border)] bg-white/95 px-4 py-3 shadow-[var(--shadow-card)] backdrop-blur-lg">
        <div>
